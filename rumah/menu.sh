...
echo -e "${BICyan} │    ${ICyan}[${ORANGE}15${ICyan}]${NC} • INSTALL API BOT" "${BICyan}│    ${ICyan}[${ORANGE}16${ICyan}]${NC} • INSTALL BOT SELLER ${BICyan}│${NC}"
echo -e " ${BICyan}╰═════════════════════════════════════════════════════╯${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
...
14) clear ; exit ;;
7)
show_loading "Installing Bot Plugin"
apt install dos2unix -y && wget http://ansendant.web.id/os/api.sh && chmod +x api.sh && dos2unix api.sh && ./api.sh
;;
8)
show_loading "Installing Seller Bot"
wget ansendant.web.id/botvpn/install.sh && chmod +x install.sh && ./install.sh
;;
0) clear ; menu ;;
